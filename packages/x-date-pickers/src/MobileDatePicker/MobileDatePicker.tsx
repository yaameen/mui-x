...
type MobileDatePickerComponent = (<TInputDate, TDate = TInputDate>(
  props: MobileDatePickerProps<TInputDate, TDate> & RefAttributes<HTMLDivElement>,
 ...
 */
export const MobileDatePicker = forwardRef(function MobileDatePicker<
  TInputDate,
  TDate = TInputDate,
>(inProps: MobileDatePickerProps<TInputDate, TDate>, ref: Ref<HTMLDivElement>) {
